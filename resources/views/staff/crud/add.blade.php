                ...
                <form action="{{ route('staff.store') }}" method="post" class="w-full flex flex-col items-start">
                    ...
                    <div class="w-full relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" height="24"
                        ...
                        <input type="text" name="id_resep" placeholder="ID Resep..."
                    ...
                    <div class="w-full relative mt-6">
                        ...
                        <input type="text" name="nama_resep" placeholder="Nama Resep..."
                            class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    <div class="w-full relative mt-6">
                        ...
                        <input type="number" name="jumlah_obat" placeholder="Jumlah Obat..."
                            class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                        ...
                        <select type="text" name="apoteker_id"
                            class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
