    ...
    <div class="flex justify-center items-center h-screen">
        ...
        <div class="absolute w-2/5 right-24 bg-white rounded-xl overflow-hidden">
            <div class="flex justify-around">
                <h1 class="w-full pt-8 pb-6 font-bold text-3xl text-center">Tambah Data Resep</h1>
            </div>
            <div class="h-full px-12 py-8 flex flex-col justify-between items-center">
                <form action="{{ route('staff.store') }}" method="post" class="w-full flex flex-col items-start">
                    @csrf
                    <div class="w-full relative">
                        ...
                        <input type="text" name="id" placeholder="ID Resep..." class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        ...
                        <input type="text" name="nama_resep" placeholder="Nama Resep..." class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        ...
                        <input type="text" name="nama_obat" placeholder="Nama Obat..." class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        ...
                        <input type="number" name="Jumlah" placeholder="Jumlah Obat..." class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                        ...
                        <select type="text" name="apoteker_id" class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                            <option value="" disabled selected>Pembuat Resep...</option>
                            @foreach ($apotekers as $apoteker)
                                <option value="{{$apoteker->id}}">{{$apoteker->nama_apoteker}}</option>
                            @endforeach
                        </select>
                    </div>

                    <button type="submit"
                        class="w-full h-auto py-4 mt-16 text-white font-medium bg-green-600 rounded-md flex justify-center items-center hover:bg-green-700">
                        Tambah Data
                    </button>
                </form>
            </div>
