    ...
    <div class="absolute w-2/5 right-24 bg-white rounded-xl overflow-hidden">
        ...
        <div class="w-full relative">
            ...
            <div class="w-full relative mt-6">
                ...
                <input type="number" name="jumlah" placeholder="Jumlah Obat..." value="{{$reseps->jumlah_obat}}" class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-green-500">
            </div>
            <div class="w-full relative mt-6">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                ...
                <select type="text" name="dosen_id" class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-green-500">
